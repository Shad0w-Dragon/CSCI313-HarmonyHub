    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.customuser')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='favorite_songs',
            field=models.ManyToManyField(through='catalog.Favorite', to='catalog.song'),
        ),
    ]
